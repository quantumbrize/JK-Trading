<div class="page-content">
    <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="rating" value=""
                                    placeholder="Enter a Rating  between 1 and 10" required=""
                                    min="1" max="10" step="1">
        ...
        <div class="text-start mb-3">
            <button class="btn btn-success w-sm" id="shop_add_btn" onclick="shop_add()">Submit</button>
        </div>
    </div>
    <!-- container-fluid -->
</div>